...
foreach ($navItems as $ni) {
 ...
 echo '<a href="#" data-target="#" class="dropdown-toggle" data-toggle="dropdown" role="button">' . $ni->name . ' <b class="caret"></b></a>'; //opens a dropdown sub-menu
 echo '<ul class="dropdown-menu'.$float.'" role="menu">'; //opens a dropdown sub-menu
 }elseif ($ni->hasSubmenu && $ni->level==2 ) {
 echo '<a href="#" data-target="#" class="dropdown-toggle" data-toggle="dropdown" role="button">' . $ni->name . ' <b class="caret"></b></a>'; //opens a dropdown sub-menu
 echo '<ul class="dropdown-menu" role="submenu">'; //opens a dropdown sub-menu
 } else {
 echo '<a href="' . $ni->url . '" target="' . $ni->target . '" class="' . $ni->classes . '">' . $ni->name . '</a>';
 echo '</li>'; //closes a nav item
 if (!$ni->isLast && $ni->level == 1 && $ni->subDepth < 1) {
